...
func testBumpFeeLowBudget(ht *lntest.HarnessTest) {
	...
	// - starting fee rate: 1 sat/vbyte
	// - deadline: 3
	// - budget: 200% of Alice's avaiable funds.
	deadlineDelta := 3
	...
	// funds can cover the fees used here, which is 66.7% of her avaiable
	...
	// cannot cover the fees now, which is 133.3% of her avaiable funds
