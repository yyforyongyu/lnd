...
func runRemoteForceCloseBeforeHtlcTimeout(ht *lntest.HarnessTest,
	...
	// Bob should have a pending anchor sweep request.
	ht.AssertNumPendingSweeps(bob, 1)

	// Mine an empty block here so the utxo nursery will broadcast the
	// sweeping tx.
	//
	// TODO(yy): handle the direct-timeout spend in the sweeper instead and
	// remove this line.
