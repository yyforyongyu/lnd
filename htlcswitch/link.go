...
func (l *channelLink) handleDownstreamPkt(ctx context.Context,
	...
	case *lnwire.UpdateFailHTLC:
		l.processLocalUpdateFaillHTLC(ctx, pkt, htlc)
	}
}
...
// processLocalUpdateFaillHTLC takes an `UpdateFailHTLC` from the local and
// processes it.
func (l *channelLink) processLocalUpdateFaillHTLC(ctx context.Context,
